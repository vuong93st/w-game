...
function kraze_hook_get_url($msisdn="",$req_id="",$game_cp_id="",$req_time = "")
{
	...
	try {	
			...
			$request_url = $kraze_param['api_url'] . "?" .  "MSISDN=" . $msisdn . "&reqTime=" .$req_time. "&shortcode=" . $kraze_param['service_id'] . "&reqId=" .$req_id. "&GameID=" . $game_cp_id . "&cmdCode=" . $kraze_param['command_code'] . "&username=" . $kraze_param['user_name'] . "&password=" .$kraze_param['password'] ;
