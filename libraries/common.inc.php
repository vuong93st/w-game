...
define('APP_ROOT', substr(dirname(__FILE__), 0, -9));
...
if(!isset($app_lang) || !file_exists(APP_ROOT.'languages'.DS.$app_lang.DS."template.inc.php")) $app_lang = "zh-cn";
...
$includes = array(
	...
	APP_ROOT. 'libraries'.DS.'smarty.pb.class.php',
