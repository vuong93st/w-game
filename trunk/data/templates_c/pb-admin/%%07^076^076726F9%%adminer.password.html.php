<?php /* Smarty version 2.6.18, created on 2010-12-21 15:35:15
...
<div class="info">
  <form method="post" action="adminer.php" id="EditFrm" name="edit_frm">
    <table class="infoTable">
      <tr>
        <th class="paddingT15"> Old Password:</th>
      ...
      <tr>
        <th class="paddingT15"> Zaishu a new password:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="data[new_pass]" type="password" id="dataNewPass" /></td>
      </tr>
      <tr>
        <th></th>
        <td class="ptb20">
			<input class="formbtn" type="submit" name="changepass" value="Change Password" />		</td>
      </tr>
    </table>
  </form>
</div>
