<?php /* Smarty version 2.6.18, created on 2010-12-21 15:35:11
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
        ...
        <li><a href="message.php?do=send">Send</a></li>
    </ul>
</div>
<div class="mrightTop"> 
    <div class="fontr"> 
...
"></th>
		  <th><label for="idAll">number</label></th>
		  <th>Sender</th>
		  <th>Recipients</th>
...
<br /><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['content'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100) : smarty_modifier_truncate($_tmp, 100)); ?>
</td>
