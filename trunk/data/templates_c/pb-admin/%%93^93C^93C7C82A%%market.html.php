<?php /* Smarty version 2.6.18, created on 2010-12-21 16:47:32
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		...
		<li><a href="quotetype.php">Quotes Category</a></li>
    </ul>
</div>
<div class="mrightTop"> 
    <div class="fontr"> 
        ...
        <input type="hidden" name="do" value="search" />
             <div>
				Keyword : <input class="queryInput" type="text" name="q" value="" />
                <span id="dataArea">
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
		  ...
		  <td><?php if ($this->_tpl_vars['item']['status'] == 1): ?>Display<?php else: ?>Does not show<?php endif; ?></td>
		  <td class="handler">
          <ul id="handler_icon">
...
" class="formbtn batchButton"/>
      <input type="submit" name="check" value="Display" class="formbtn batchButton"/>
      <input type="submit" name="uncheck" value="Does not show" class="formbtn batchButton"/>
    </div>
