<?php /* Smarty version 2.6.18, created on 2010-12-21 16:47:15
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		...
		<li><a href="newsgather.php">Acquisition</a></li>
    </ul>
</div>
<div class="mrightTop"> 
    <div class="fontr"> 
        ...
        <input type="hidden" name="do" value="search" />
             <div> 
				Heading Keyword : <input class="queryInput" type="text" name="q" value="<?php echo $_GET['q']; ?>
" /> 
...
"></th>
		  <th><label for="idAll">News Headlines</label></th>
		  <th>Focus headlines</th>
		  <th>Category Name</th>
		  <th>Viewed</th>
		  <th>Pub Date</th>
...
"><?php echo $this->_tpl_vars['item']['title']; ?>
		  ...
		  <td><input type="radio" name="if_focus" <?php if ($this->_tpl_vars['item']['if_focus'] == '1'): ?>checked<?php endif; ?> value="<?php echo $this->_tpl_vars['item']['id']; ?>
" value="<?php echo $this->_tpl_vars['item']['id']; ?>
" /></td>
		  <td><a title="<?php echo $this->_tpl_vars['Newstypes'][$this->_tpl_vars['item']['type_id']]; ?>
...
" class="formbtn batchButton"/>
      <input type="submit" name="update" value="<?php echo $this->_tpl_vars['_set_headline']; ?>
" class="formbtn batchButton"/>
      <input type="submit" name="commend" value="Recommended" class="formbtn batchButton"/>
      <input type="submit" name="cancel_commend" value="Cancel recommended" class="formbtn batchButton"/>
    </div>
