<?php /* Smarty version 2.6.18, created on 2010-12-21 16:47:19
...
"></th>
		  <th><label for="idAll">Company Name</label></th>
...
"><?php echo $this->_tpl_vars['item']['companyname']; ?>
		  ...
		  <td><?php if ($this->_tpl_vars['item']['CompanynewsStatus'] == 1): ?>Normal<?php else: ?>Invalid<?php endif; ?></td>
...
" title="Pushed to the News">Pushed to the News</a></li>
          </ul>  
		  </td>
		</tr>
		<?php endforeach; else: ?>
...
" class="formbtn batchButton"/>
      <input type="submit" name="check" value="Audit" class="formbtn batchButton"/>
    </div>
