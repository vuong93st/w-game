<?php /* Smarty version 2.6.18, created on 2011-01-01 17:15:15
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a class="btn1" href="type.php"><span>All Options</span></a></li>       
        <li><a href="type.php?do=edit"><?php echo $this->_tpl_vars['_edit']; ?>
</a></li>
...
"></th>
		  <th><label for="idAll">Tags</label></th>
...
">Edit</a>&nbsp;<a href="type.php?do=del&id=<?php echo $this->_tpl_vars['item']['id']; ?>
">Delete</a></td>
		</tr>
		<?php endforeach; else: ?>
