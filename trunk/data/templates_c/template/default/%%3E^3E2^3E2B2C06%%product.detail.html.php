<?php /* Smarty version 2.6.18, created on 2011-01-01 17:22:40
         compiled from default%5Cproduct.detail.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'nl2br', 'default\\product.detail.html', 63, false),array('block', 'product', 'default\\product.detail.html', 88, false),array('block', 'price', 'default\\product.detail.html', 96, false),)), $this); ?>
...
<a href="offer/list.php?areaid=<?php echo $this->_tpl_vars['item']['area_id1']; ?>
" target="_blank"><?php echo $this->_tpl_vars['Areas'][1][$this->_tpl_vars['item']['area_id1']]; ?>
</a>&raquo;<a href="offer/list.php?areaid=<?php echo $this->_tpl_vars['item']['area_id2']; ?>
" target="_blank"><?php echo $this->_tpl_vars['Areas'][2][$this->_tpl_vars['item']['area_id2']]; ?>
</a></p>
                   <p><?php echo $this->_tpl_vars['_belong_industry']; ?>
<a href="offer/list.php?industryid=<?php echo $this->_tpl_vars['item']['industry_id1']; ?>
" target="_blank"><?php echo $this->_tpl_vars['Industry'][1][$this->_tpl_vars['item']['industry_id1']]; ?>
</a>&raquo;<a href="offer/list.php?industryid=<?php echo $this->_tpl_vars['item']['industry_id2']; ?>
" target="_blank"><?php echo $this->_tpl_vars['Industry'][2][$this->_tpl_vars['item']['industry_id2']]; ?>
</a></p>
				   <p><?php echo $this->_tpl_vars['_keyword']; ?>
...
"  class="leftbutton" onclick="redirect('<?php echo $this->_tpl_vars['SiteUrl']; ?>
...
"  class="leftbutton" onclick="redirect('<?php echo $this->_tpl_vars['SiteUrl']; ?>
office-room/product.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
');" />
					</label>
					<?php endif; ?>
...
"  class="leftbutton" onclick="redirect('<?php echo $this->_tpl_vars['SiteUrl']; ?>
office-room/price.php?do=edit&productid=<?php echo $this->_tpl_vars['item']['id']; ?>
');" />
					</label>
                    <?php endif; ?>
				  </p>
...
<a href="space.php?userid=<?php echo $this->_tpl_vars['item']['space_name']; ?>
...
?>
					<tr>
					  <td class="tableblue"><?php echo $this->_tpl_vars['tparam']['label']; ?>
</td>
					  <td class="lightblue"><?php echo $this->_tpl_vars['tparam']['value']; ?>
</td>
				</tr>
               	<?php endforeach; endif; unset($_from); ?>
			   </table>
               <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['content'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
<?php echo $this->_tpl_vars['item']['site_url']; ?>
			...
			<div class="contacttype">
				<h3><img src="<?php echo $this->_tpl_vars['theme_img_path']; ?>
images/lhighs.gif" alt="" /><?php echo $this->_tpl_vars['_add_information_release']; ?>
</h3>
				<ul>
                	<?php $this->_tag_stack[] = array('product', array('memberid' => ($this->_tpl_vars['item']['member_id']),'row' => 10)); $_block_repeat=true;smarty_block_product($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
					<li><a href="[link:title]" title="[field:fulltitle]">[field:title]</a></li>
			...
			<div class="contacttype">
				<h3><img src="<?php echo $this->_tpl_vars['theme_img_path']; ?>
images/lhighs.gif" alt="" /><?php echo $this->_tpl_vars['_linked_product_price']; ?>
</h3>
				<ul>
                	<?php $this->_tag_stack[] = array('price', array('productid' => ($this->_tpl_vars['item']['id']),'row' => 10)); $_block_repeat=true;smarty_block_price($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
					<li><a href="[link:title]" title="[field:fulltitle]">[field:title]</a></li>
