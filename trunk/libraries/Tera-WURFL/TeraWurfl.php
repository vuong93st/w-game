...
require_once (APP_ROOT. 'configs/TeraWurflConfig.php');
require_once (LIB_PATH . 'Tera-WURFL/DatabaseConnectors/TeraWurflDatabase.php');
require_once (LIB_PATH . '/Tera-WURFL/TeraWurflLoader.php');
require_once (LIB_PATH . '/Tera-WURFL/UserAgentFactory.php');
require_once (LIB_PATH . '/Tera-WURFL/UserAgentUtils.php');
require_once (LIB_PATH . '/Tera-WURFL/WurflConstants.php');
require_once (LIB_PATH . '/Tera-WURFL/WurflSupport.php');
require_once (LIB_PATH . '/Tera-WURFL/UserAgentMatchers/UserAgentMatcher.php');
/**#@-*/
/**
