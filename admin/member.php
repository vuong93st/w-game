...
$fields = "id,username,CONCAT(mf.first_name,mf.last_name) AS NickName,points,credits,cp_id,membergroup_id,status,created AS pubdate,last_login,trusttype_ids";
