<?php /* Smarty version 2.6.18, created on 2011-05-03 23:57:55
         compiled from request.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'fetch', 'request.html', 2, false),)), $this); ?>
...
<div class="mrightTop"> 
    <div class="fontr"> 
        <form name="search_frm" action="request.php" id="SearchFrm" method="get">
...
<div class="tdare" style="margin-top:30px">
  <form name="list_frm" id="ListFrm" action="request.php" method="post">
