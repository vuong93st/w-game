<?php /* Smarty version 2.6.18, created on 2011-05-03 23:57:37
         compiled from member.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'member.html', 22, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['item']['username']; ?>
			  ...
			  <td><?php if ($this->_tpl_vars['item']['pubdate'] > $this->_tpl_vars['today_timestamp']): ?>&nbsp;<img src="images/new.gif" /><?php endif; ?></td>
			  <td><?php echo $this->_tpl_vars['MemberStatus'][$this->_tpl_vars['item']['status']]; ?>
</td>
			  <td><?php echo $this->_tpl_vars['item']['NickName']; ?>
</td>
			  <td><?php echo $this->_tpl_vars['item']['trust_image']; ?>
</td>
			  <td><a href="member.php?do=search&groupid=<?php echo $this->_tpl_vars['item']['membergroup_id']; ?>
"><img src="../images/group/<?php echo $this->_tpl_vars['Membergroups'][$this->_tpl_vars['item']['membergroup_id']]['avatar']; ?>
