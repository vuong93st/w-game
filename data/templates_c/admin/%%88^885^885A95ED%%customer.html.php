<?php /* Smarty version 2.6.18, created on 2011-05-03 23:57:34
         compiled from customer.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'fetch', 'customer.html', 2, false),)), $this); ?>
...
<div class="mrightTop"> 
    <div class="fontr"> 
        <form name="search_frm" action="customer.php" id="SearchFrm" method="get">
...
<div class="tdare" style="margin-top:10px">
  <form name="list_frm" id="ListFrm" action="customer.php" method="post">
  <table style="margin-top:20px;" width="100%" cellspacing="0" class="dataTable" summary="<?php echo $this->_tpl_vars['_data_zone']; ?>
">
    <thead>
		<tr>
		  <th width="20px" align="left" class="firstCell"><input type="checkbox" name="idAll" id="idAll" onClick="pbCheckAll(this,'id[]');" title="<?php echo $this->_tpl_vars['_select_switch']; ?>
"></th>
		  <th width="100px"><label for="idAll">Số điện thoại</label></th>
		  <th width="130px">Ngày tạo </th>
  		  <th width="80px">Mã yêu cầu</th>
		  <th width="80px">Mã game</th>
		  <th width="80px">Mã CP</th>
		  <th width="40px" align="center">URL</th>
		  <th width="60px">Số lần tải </th>		  
		  <th width="40px">Gọi từ </th>		  
		  <th width="200px">Thao tác</th>
		</tr>
    </thead>
    <tbody>		<?php $_from = $this->_tpl_vars['Items']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['adzone'] = array('total' => count($_from), 'iteration' => 0);
...
"></td>
		  <td><a href="#"><label for="item_<?php echo $this->_tpl_vars['item']['msisdn']; ?>
...
" style="display:none;"><?php echo $this->_tpl_vars['item']['cp_game_url']; ?>
</div>
		  	<?php if ($this->_tpl_vars['item']['cp_game_url'] != ''): ?>&nbsp;<a href="#info<?php echo $this->_tpl_vars['item']['Id']; ?>
" rel="facebox"><img src="images/right.gif" title="<?php echo $this->_tpl_vars['item']['cp_game_url']; ?>
"/></a><?php endif; ?></td>		  
		  <td><a href="download.detail.php?req_key=<?php echo $this->_tpl_vars['item']['req_key']; ?>
"><?php echo $this->_tpl_vars['item']['totals']; ?>
</a></td>
		  <td><?php echo $this->_tpl_vars['item']['user_name']; ?>
</td>
		  <td class="handler">
          	<?php if ($this->_tpl_vars['item']['cp_game_url'] != ''): ?>&nbsp;<img src="images/success.png" title="<?php echo $this->_tpl_vars['item']['cp_game_url']; ?>
"/><?php else: ?><a href="../process.php?ref=<?php echo $this->_tpl_vars['item']['req_key']; ?>
" target="_blank"><img src="images/notice.png" title="<?php echo $this->_tpl_vars['item']['cp_game_url']; ?>
"/></a><?php endif; ?>		 </td>
		</tr>
		<?php endforeach; else: ?>
