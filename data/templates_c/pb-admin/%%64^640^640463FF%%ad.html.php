<?php /* Smarty version 2.6.18, created on 2010-12-21 16:03:06
...
"><?php echo $this->_tpl_vars['item']['title']; ?>
		  ...
		  <td><a title="Click Search" href="ad.php?do=search&adzone_id=<?php echo $this->_tpl_vars['item']['adzone_id']; ?>
...
" rel="facebox"><img class="double-border" src="<?php echo $this->_tpl_vars['item']['src']; ?>
...
" class="formbtn batchButton"/>
      <input type="submit" name="down" value="Offline" class="formbtn batchButton"/>
      <input type="submit" name="up" value="On-line" class="formbtn batchButton"/>
    </div>
