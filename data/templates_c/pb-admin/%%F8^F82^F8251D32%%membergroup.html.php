<?php /* Smarty version 2.6.18, created on 2010-12-21 15:35:10
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a class="btn1" href="membergroup.php"><span>All <?php echo $this->_tpl_vars['_membergroup']; ?>
</span></a></li>
        <li><a href="membergroup.php?type=system">System <?php echo $this->_tpl_vars['_membergroup']; ?>
</a></li>
        <li><a href="membergroup.php?type=define">Defined <?php echo $this->_tpl_vars['_membergroup']; ?>
</a></li>
        <li><a href="membergroup.php?type=special">Special <?php echo $this->_tpl_vars['_membergroup']; ?>
</a></li>
...
"></th>
		  ...
		  <th>Default</th>
		  <?php if ($this->_tpl_vars['MembergroupType'] == 'system'): ?><th>Points between</th><?php endif; ?>
		  <th>Legend</th>
