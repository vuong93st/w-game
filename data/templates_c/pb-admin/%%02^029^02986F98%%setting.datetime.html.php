<?php /* Smarty version 2.6.18, created on 2010-12-21 16:20:12
...
<div class="info"> 
  ...
  <input type="hidden" name="do" value="functions">
    <table class="infoTable">
      <tr>
        <th class="paddingT15"> Default date format:</th>
...
"/>
          <span class="gray">Support and style of <a href="http://www.php.net/strftime" target="_blank">strftime</a>, such as “%Y-%m-%d” mean <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</span></td>
      </tr>
      <tr>
        <th class="paddingT15"> Default Time difference:</th>
...
"/>
          <span class="gray">The time difference between local time and GMT, GMT time is:<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %H:%M:%S") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %H:%M:%S")); ?>
</span></span></td>
      </tr>
      <tr>
        <th></th>
