<?php /* Smarty version 2.6.18, created on 2010-12-21 16:47:41
...
"></th>
		  <th><label for="idAll">Show Name</label></th>
...
" class="formbtn batchButton"/>
      <input type="submit" name="up" value="设为<?php echo $this->_tpl_vars['_commend']; ?>
" class="formbtn batchButton"/>
    </div>
