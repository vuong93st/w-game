<?php /* Smarty version 2.6.18, created on 2010-12-21 15:36:22
    ...
    <div class="fontr"> 
        ...
        <input type="hidden" name="do" value="search" />
             <div> 
				...
				<option value="0">Supply and demand type</option>
...
"></th>
		  <th></th>
		  <th><label for="idAll">Topics</label></th>
		  <th><label for="idAll"><?php echo $this->_tpl_vars['_types']; ?>
</label></th>
...
" class="formbtn batchButton"/>
      <input type="submit" name="cancel_urgent_batch" value="Cancel emergency" class="formbtn batchButton"/>
