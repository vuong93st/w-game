<?php /* Smarty version 2.6.18, created on 2011-01-01 17:15:37
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a class="btn1" href="trust.php"><span>Authentication Type</span></a></li>
		<li><a href="trust.php?do=rule">Integrity Index</a></li>
    </ul>
</div>
<div class="mrightTop"> 
    <div class="fontl">If you change a certain type of number may have been caused by supply and demand data errors.</div> 
    <div class="fontr"></div> 
</div> 
<div class="tdare">
...
"><?php echo $this->_tpl_vars['_delete']; ?>
	...
	<tr class="tatr2">
		<td></td>
		<td colspan="3"><img src="images/add.gif" /><a href="javascript:;" onclick="$('#tRow0').clone().show().appendTo( $('#tRow0').parent() );" style="color: blue;">&nbsp;Adding new types</a></td>
	</tr>
	</table>
